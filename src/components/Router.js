  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route path="/Mypage" exact={true}><Mypage refreshUser={refreshUser} userObj={userObj} /></Route>
        <Route path="/Profile" exact={true}><Profile refreshUser={refreshUser} userObj={userObj} /></Route>

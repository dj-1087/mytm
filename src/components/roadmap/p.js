...
const rows = [
  createData(
    <button>와진짜 대박이다 이거다 어떻게 갖고오지?</button>,
    159,
    6.0,
    24,
    4.0
  ...
  createData("Element.LectureButton.buttons()", 262, 16.0, 24, 6.0),
  createData("LectureButton.button[this.#자료구조]", 305, 3.7, 67, 4.3),
  createData("", 356, 16.0, 49, 3.9),
  createData("(#알고리즘').attr(#알고리즘)", 356, 16.0, 49, 3.9),
  createData("", 356, 16.0, 49, 3.9),
  createData("", 356, 16.0, 49, 3.9),
  createData("", 356, 16.0, 49, 3.9),
];
